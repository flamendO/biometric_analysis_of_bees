# -*- coding: utf-8 -*-
"""
Created on Wed Jan 24 16:25:05 2024
...
def func(I):
    ...
    I_meij *= 255 # or any coefficient
    I_meij = I_meij.astype(np.uint8)
    #skio.imsave(main_pathname/'image 2024', I_meij)
...
def detection_pattern_cubital(image): 
    ...
    pattern_ref = skio.imread(main_pathname / 'Image 2024 /Masque_cubital.jpg')
...
def detection_pattern_anthem(image):
    ...
    pattern_ref = skio.imread(main_pathname / 'Image 2024 /Masque_anthem.jpg')
    pattern_ref = skc.rgb2gray(pattern_ref)
